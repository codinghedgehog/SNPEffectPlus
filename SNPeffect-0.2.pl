...
##########################################################################
##########################################################################
# NOTE: Original development credited to Patrick Shea
...
#        print "\n";
#};
print "Position\tGeneID\tName\tType\tPos_in_Gene\tINDEL_Length\tRef_base\tSample_base\tRef_Codon\tSample_Codon\tRef_AA\tSample_AA\tSubstitution\n";
